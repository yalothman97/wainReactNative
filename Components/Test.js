    ...
    return (
      <ScrollView contentContainerStyle={styles.container}>
        <Text style={styles.labelText}>
          Using an array of objects with max of 3 items:
        </Text>
          ...
          <View style={styles.buttonInner}>
            <Button
              ...
              onPress={() => {
                Alert.alert(
                  "Selected count",
                  `Total: ${this.tagString.totalSelected}`
                );
              }}
            />
          </View>
          <View>
            <Button
              ...
              onPress={() => {
                Alert.alert(
                  "Selected items:",
                  JSON.stringify(this.tagString.itemsSelected)
                );
              }}
            />
          </View>
